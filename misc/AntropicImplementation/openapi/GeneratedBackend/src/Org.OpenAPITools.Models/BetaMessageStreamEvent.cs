...
{ 
    ...
    /// </summary>
    [DataContract]
    [JsonSubtypes.KnownSubType(typeof(BetaContentBlockDeltaEvent), "content_block_delta")]
    [JsonSubtypes.KnownSubType(typeof(BetaContentBlockStartEvent), "content_block_start")]
    [JsonSubtypes.KnownSubType(typeof(BetaContentBlockStopEvent), "content_block_stop")]
    [JsonSubtypes.KnownSubType(typeof(BetaMessageDeltaEvent), "message_delta")]
    [JsonSubtypes.KnownSubType(typeof(BetaMessageStartEvent), "message_start")]
    [JsonSubtypes.KnownSubType(typeof(BetaMessageStopEvent), "message_stop")]
    public partial class BetaMessageStreamEvent 
    {
        ...
        public BetaMessageDeltaUsage Usage { get; set; }
