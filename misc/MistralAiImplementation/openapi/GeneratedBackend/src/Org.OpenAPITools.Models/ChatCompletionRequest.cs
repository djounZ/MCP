...
{ 
    ...
    public partial class ChatCompletionRequest 
    {
        ...
        /// </summary>
        /// <value>ID of the model to use. You can use the [List Available Models](/api/#tag/models/operation/list_models_v1_models_get) API to see all of your available models, or see our [Model overview](/models) for model descriptions.</value>
        [Required]
        ...
        [DataMember(Name="safe_prompt", EmitDefaultValue=true)]
