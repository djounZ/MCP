...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationResponseOutputsInner 
    {
        ...
        public TypeEnum Type { get; set; } = TypeEnum.MessageOutputEnum;
        ...
        public FunctionCallEntryArguments Arguments { get; set; }
