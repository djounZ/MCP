...
{ 
    ...
    /// </summary>
    [DataContract]
    [JsonSubtypes.KnownSubType(typeof(ClassifierJobOut), "classifier")]
    [JsonSubtypes.KnownSubType(typeof(CompletionJobOut), "completion")]
    public partial class ResponseAnyOf 
    {
        /// <summary>
        /// The ID of the job.
        /// </summary>
