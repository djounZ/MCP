...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CreateRunRequestWithoutStream 
    {
        /// <summary>
        ...
        public CreateRunRequestWithoutStreamModel? Model { get; set; }
        ...
        /// </summary>
        /// <value>Overrides the [instructions](https://platform.openai.com/docs/api-reference/assistants/createAssistant) of the assistant. This is useful for modifying the behavior on a per-run basis.</value>
