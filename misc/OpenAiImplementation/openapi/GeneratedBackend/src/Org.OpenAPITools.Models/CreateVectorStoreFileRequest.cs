...
{ 
    ...
    public partial class CreateVectorStoreFileRequest 
    {
        ...
        /// </summary>
        /// <value>A [File](https://platform.openai.com/docs/api-reference/files) ID that the vector store should use. Useful for tools like &#x60;file_search&#x60; that can access files.</value>
        [Required]
