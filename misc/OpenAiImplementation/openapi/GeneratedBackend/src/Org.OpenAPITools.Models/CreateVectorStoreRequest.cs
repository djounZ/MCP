...
{ 
    ...
    public partial class CreateVectorStoreRequest 
    {
        ...
        /// </summary>
        /// <value>A list of [File](https://platform.openai.com/docs/api-reference/files) IDs that the vector store should use. Useful for tools like &#x60;file_search&#x60; that can access files.</value>
