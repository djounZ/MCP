...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RealtimeConversationItemWithReference 
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>For an item of type (&#x60;message&#x60; | &#x60;function_call&#x60; | &#x60;function_call_output&#x60;) this field allows the client to assign the unique ID of the item. It is not required because the server will generate one if not provided.  For an item of type &#x60;item_reference&#x60;, this field is required and is a reference to any item that has previously existed in the conversation. </value>
        ...
        /// </summary>
        /// <value>The type of the item (`message`, `function_call`, `function_call_output`, `item_reference`). </value>
        ...
        public List<RealtimeConversationItemWithReferenceContentInner> Content { get; set; }
