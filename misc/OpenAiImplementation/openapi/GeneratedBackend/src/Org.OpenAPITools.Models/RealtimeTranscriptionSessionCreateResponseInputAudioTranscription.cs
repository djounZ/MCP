...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RealtimeTranscriptionSessionCreateResponseInputAudioTranscription 
    {

        /// <summary>
        /// The model to use for transcription. Can be `gpt-4o-transcribe`, `gpt-4o-mini-transcribe`, or `whisper-1`. 
        /// </summary>
        /// <value>The model to use for transcription. Can be `gpt-4o-transcribe`, `gpt-4o-mini-transcribe`, or `whisper-1`. </value>
        ...
        /// </summary>
        /// <value>An optional text to guide the model&#39;s style or continue a previous audio segment. The [prompt](https://platform.openai.com/docs/guides/speech-to-text#prompting) should match the audio language. </value>
