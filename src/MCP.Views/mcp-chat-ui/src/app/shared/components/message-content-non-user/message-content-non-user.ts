...
@Component({
    selector: 'app-message-content-non-user',
    templateUrl: './message-content-non-user.html',
    styleUrl: './message-content-non-user.scss',
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [MatIconModule, MatProgressSpinnerModule]
})
export class MessageContentNonUserComponent {
